        ...
        <div className="footer">
            ...
            <div className='footer__botNav'>
                <div className="grid wide">
                    <div className='row'>
                        <div style={{ "font-family": "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }} className="footer__description col c-12 m-4 l-4">
                        ...
                        <div style={{ "font-family": "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }} className='footer__followUs col c-12 m-4 l-4'>
